...
class ConsoleConfig {
     ...
     * Other remotes with different remoting channel won't be able to connect your openfl.
     ...
     * <p>
     * CommandLine is a big security risk for your code and openfl.
     ...
     * </p>
     */
    public var commandLineAllowed:Bool;
     ...
     * </p>
     */
    public var commandLineAutoScope:Bool;
    ...
    /**
     * Display Roller tilemap capturing
     * <p>
     * Display Roller starts capturing Tiles in Tilemap.
     * </p>
     */
    public var displayRollerTilemapCapturingEnabled:Bool = false;
     ...
     * </ul>
     */
    public var rememberFilterSettings:Bool;
     ...
     */
    public var style(get, never):ConsoleStyle;
